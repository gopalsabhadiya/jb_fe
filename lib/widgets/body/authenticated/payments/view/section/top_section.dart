...
class ViewReceiptTopSection extends StatelessWidget {
  final PartyPresentation _party;
  const ViewReceiptTopSection({Key? key, required PartyPresentation party})
      : _party = party,
        super(key: key);
          ...
          Row(
            children: [
              Icon(
                ...
                size: 25,
                color: _party.balance >= 0 ? AppColors.blue_5 : AppColors.red_2,
              ),
              Padding(
